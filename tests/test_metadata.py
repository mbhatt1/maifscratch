...
from maif.metadata import (
    MAIFVersion, ContentType, CompressionType, MAIFHeader, BlockMetadata,
    ProvenanceRecord, MAIFMetadataManager
)
...
class TestMAIFMetadataManager:
    ...
    def test_custom_schema_management(self):
        ...
        errors = self.metadata_manager.validate_custom_metadata("custom_block", "custom_schema")
        ...
        errors = self.metadata_manager.validate_custom_metadata("invalid_custom_block", "custom_schema")
    ...
    def test_statistics_generation(self):
        ...
        for i, block_id in enumerate(["text_block_1", "text_block_2", "binary_block_1"]):
            self.metadata_manager.add_provenance_record(
                operation_type="create",
                agent_id=f"agent_{i}",
                block_id=block_id
