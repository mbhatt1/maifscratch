...
def test_everything():
    ...
    try:
        ...
        assert 'compression_ratio' in result['metadata'], "HSC failed - no compression ratio"
        assert result['metadata']['compression_ratio'] > 0, "HSC failed - invalid compression ratio"
        print("✅ HSC working")
