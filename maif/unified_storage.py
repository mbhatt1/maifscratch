...
from .unified_block_format import (
    UnifiedBlock, UnifiedBlockHeader, BlockType, 
    BlockFormatConverter, UnifiedBlockFlags
)
...
class LocalFileBackend(UnifiedStorageBackend):
    ...
    def __init__(self, file_path: str):
        ...
        self.blocks: Dict[str, Tuple[int, UnifiedBlockHeader]] = {}  # uuid -> (offset, header)
            ...
            try:
                ...
                header_block = UnifiedBlock(
                    header=UnifiedBlockHeader(
                        block_type=BlockType.HEADER.value,
                        size=0
                    ),
                    data=b'',
                    metadata={
        ...
        with self._lock:
            ...
            try:
                with open(self.file_path, 'rb') as f:
                    ...
                    # Read full block
                    total_size = (UnifiedBlockHeader.HEADER_SIZE + 
...
class AWSS3Backend(UnifiedStorageBackend):
    ...
    def __init__(self, bucket_name: str, prefix: str = "maif/", 
                 s3_client=None, enable_cache: bool = True):
...
class UnifiedStorage:
    ...
    def __init__(self, storage_path: str, use_aws: bool = False,
    ...
    def add_block(self, block_type: Union[str, BlockType], data: bytes,
    ...
    def update_block(self, block_uuid: str, data: bytes,
