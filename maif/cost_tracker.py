...
class CostTracker:
    ...
    SERVICE_COSTS = {
        ...
        "bedrock_embedding": ServiceCost("bedrock", Decimal("0.0001"), "per_1k_chars", 0),
        ...
        "lambda_requests": ServiceCost("lambda", Decimal("0.0000002"), "per_request", 1000000),
        "lambda_duration": ServiceCost("lambda", Decimal("0.0000166667"), "per_gb_second", 400000),
    ...
    def _check_budget(self, new_cost: Decimal):
        ...
        for threshold in self.budget.alert_thresholds:
            ...
            if period_cost >= threshold_amount and (period_cost - new_cost) < threshold_amount:
    ...
    async def _monitor_costs(self):
        ...
        while self._running:
            try:
                ...
                # Log current costs
                logger.info(f"Current period cost: ${report['current_period_cost']:.4f}")
...
def with_cost_tracking(service: str, operation: str, unit_calculator: Optional[Callable] = None):
