...
class BlockHeader:
    ...
    def to_bytes(self) -> bytes:
        ...
        header = struct.pack('>I4sII', self.size, self.type.encode('ascii')[:4].ljust(4, b'\0'), 
...
class BlockFactory:
    ...
    @staticmethod
    def create_header_block(maif_version: str, creator_id: str, root_hash: str) -> Dict[str, Any]:
        """Create HDER block."""
        return {
            ...
            'data': {
                ...
                'format_features': ['multimodal', 'semantic', 'cryptographic', 'streaming']
            }
        }
    
    @staticmethod
    def create_text_block(text: str, language: str = 'en', encoding: str = 'utf-8') -> Dict[str, Any]:
        """Create TEXT block."""
        return {
    ...
    @staticmethod
    def create_embedding_block(embeddings: List[List[float]], model_name: str, 
    ...
    @staticmethod
    def create_knowledge_graph_block(triples: List[Dict], format_type: str = 'json-ld') -> Dict[str, Any]:
        """Create KGRF block."""
        import json
    ...
    @staticmethod
    def create_security_block(signatures: Dict, certificates: List, 
                            access_control: Dict) -> Dict[str, Any]:
        """Create SECU block."""
        import json
    ...
    def validate_block_data(block_type: str, data: bytes, metadata: Dict) -> List[str]:
        ...
        if block_type == BlockType.TEXT_DATA.value:
            ...
            if len(data) != expected_size:
                errors.append(f"Embedding data size mismatch: expected {expected_size}, got {len(data)}")
